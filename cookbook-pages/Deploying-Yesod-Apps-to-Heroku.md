> Note: this page describes the method of compiling the yesod app locally and uploading it to Heroku's servers. The alternative (and preferred) approach is to use a [Haskell Buildpack for Heroku](https://github.com/begriffs/heroku-buildpack-ghc).
